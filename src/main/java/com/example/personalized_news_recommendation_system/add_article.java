...
public class add_article {
    ...
    public void submitArticle() {
        try {
            ...
            String category = predictCategory(content);
    ...
    private String predictCategory(String content) throws Exception {
        String apiUrl = "https://api-inference.huggingface.co/models/facebook/bart-large-mnli";
        String token = "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9";

        String[] labels = {"politics", "technology", "health", "business", "education"};
    ...
    private String parseCategoryFromResponse(String response) {
        int startIndex = response.indexOf("\"label\":\"") + 9;
