...
public class add_article {
    ...
    public static void main(String[] args) {
        try {
            String content = "5G is not just about faster internet—it’s about revolutionizing the wa…";
            add_article obj = new add_article();
            String[] labels = {"politics", "technology", "health", "business", "education"};
            String predictedCategory = obj.predictCategory(content, labels);
