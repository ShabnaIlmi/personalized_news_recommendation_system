...
public class sign_up implements Initializable {
    ...
    private void signUp(ActionEvent actionEvent) {
        ...
        Document newUser = new Document()
                ...
                .append("password", hashPassword(password)); // Replace plain password storage

        try {
            userCollection.insertOne(newUser);
            showAlert("Registration Success", "Your username is: " + username, Alert.AlertType.INFORMATION);
    ...
    private String generateUsername(String firstName, String lastName) {
        ...
        return firstName.toLowerCase() + lastName.substring(0, 1).toUpperCase() + lastName.substring(1).toLowerCase();
    }
